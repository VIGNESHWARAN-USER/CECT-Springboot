...
const Preview = () => {
  ...
  const handleApprove = async (id, Email) => {
    ...
    try 
    {
      ...
      await axios.post(`http://localhost:8080/api/approvedetails`, { id:id, email:Email, role:userrole });
  ...
  const handleReject = async (id, Email) => {
    ...
    try 
    {
      await axios.post(`http://localhost:8080/api/rejectdetails`, { id:id, email:Email, role:userrole });
