...
const PreviewDrop = () => {
  ...
  const handleApprove = async (id, Email) => {
    try {
      ...
      await axios.post(`http://localhost:8080/api/approvedrops`, { id:id, email:Email, role:userrole });
  ...
  const handleReject = async (id, Email) => {
    try {
      ...
      await axios.post(`http://localhost:8080/api/rejectdrops`, { id:id, email:Email, role:userrole });
